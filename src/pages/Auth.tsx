  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === "k8716610@gmail.com" && password === "9848+-ab") {
        ...
        // Navigate to the return path or admin page
        navigate(returnPath || "/admin");
        return;
      }
    ...
    <Layout>
      <div className="flex items-center justify-center min-h-[80vh]">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle>
              {returnPath === "/admin" ? "Admin Authentication Required" : "Welcome to Smart Appointment System"}
            </CardTitle>
            <CardDescription>
              {returnPath === "/admin" 
          ...
          <CardContent>
            <Tabs value={returnPath === "/admin" ? "signin" : activeTab} 
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full" disabled={loading}>
                    {loading ? "Signing in..." : returnPath === "/admin" ? "Access Admin Panel" : "Sign In"}
                  </Button>
                </form>
